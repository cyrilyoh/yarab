...
<div class="card">
  <form method="post" action="<?php echo base_url('welcome/saveuser');?>">
  <div class="card-header">Register</div>
  <div class="card-body">
    <b class="text-danger"><?php echo validation_errors();?></b>
    <b class="text-success"><?php echo $this->session->flashdata('success'); ?></b>
    <b class="text-danger"><?php echo $this->session->flashdata('Invalid'); ?></b>
    <div class="form-group">
      <label>First Name</label>
      <input type="text" name="fname" class="form-control" required value="<?php echo set_value('fname');?>">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label>Enter the number <span style="background-color: yellow; font-weight: bold;"><?php echo $capt;?></span></label>
      <input type="text" name="captcha" class="form-control" placeholder="Captcha" required>
    </div>
  </div>
  <div class="card-footer">
  <input type="submit" name="submit" value="Register" onclick="return ValidateNumber()" class="btn btn-primary form-control">
  <br><br>
  <a href="<?php echo base_url('/');?>">Login Now</a>
</div>
</form>
</div>
</div>
<script type="text/javascript">
 function ValidateNumber() {
  var ph = document.getElementById('phone').value;
        if (ph.length < 11) {
            alert('Invald Phone Number. Enter a UK number');
            return false;
        }
        else {
            if (ph.charAt(0) != "0") {
